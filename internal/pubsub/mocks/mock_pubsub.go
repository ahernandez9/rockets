...
import (
	...
	pubsub "github.com/ahernandez9/rockets/internal/pubsub"
...
func (m *MockPublisher) Publish(ctx context.Context, msg *models.RocketMessage) error {
	m.ctrl.T.Helper()
...
// Publish mocks base method.
func (m *MockInterface) Publish(ctx context.Context, msg *models.RocketMessage) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Publish", ctx, msg)
	ret0, _ := ret[0].(error)
	return ret0
...
// Publish indicates an expected call of Publish.
func (mr *MockInterfaceMockRecorder) Publish(ctx, msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Publish", reflect.TypeOf((*MockInterface)(nil).Publish), ctx, msg)
}

// Subscribe mocks base method.
func (m *MockInterface) Subscribe(ctx context.Context, handler pubsub.MessageHandler) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Subscribe", ctx, handler)
	ret0, _ := ret[0].(error)
	return ret0
...
// Subscribe indicates an expected call of Subscribe.
func (mr *MockInterfaceMockRecorder) Subscribe(ctx, handler any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Subscribe", reflect.TypeOf((*MockInterface)(nil).Subscribe), ctx, handler)
}
